      ...
      <div style={{ position: "relative", zIndex: 1, width: "100%" }}>
        ...
        {s.subtitle && (
          <EditableText
            ...
            on={ed?.subtitle}
            block
            style={{ fontSize: 13, color: "#666", lineHeight: 1.65, marginBottom: 28, maxWidth: 200 }}
          />
        )}
    ...
    >
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center" }}>
        <EditableText
          ...
          on={ed?.heading}
          block
          style={{ fontSize: 20, fontWeight: 900, color: "#111", lineHeight: 1.3, marginBottom: 16 }}
        />
  ...
  return (
    ...
    >
      ...
      <EditableText
        ...
        on={ed?.cta}
        block
        style={{ fontSize: 20, fontWeight: 900, color: "#111", marginBottom: 8, lineHeight: 1.35 }}
      />
      <EditableText
        v={s.sub}
        on={ed?.sub}
        block
        style={{ fontSize: 13, color: "#888", marginBottom: 28, lineHeight: 1.6 }}
      />
