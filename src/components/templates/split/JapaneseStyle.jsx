...
export function JapaneseCover({ s, a, total, ed }) {
  return (
    <div style={{ background: "#f8f5f0", width: "100%", aspectRatio: "3/4", fontFamily: FONT_FAMILY, position: "relative", overflow: "hidden", display: "flex", flexDirection: "column" }}>
      <div style={{ flex: 1, display: "flex", flexDirection: "column", padding: "40px 32px", position: "relative" }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", position: "relative", zIndex: 1 }}>
          ...
          <EditableText v={s.title} on={ed?.title} block style={{ fontSize: 32, fontWeight: 800, color: "#1a1a1a", lineHeight: 1.25, paddingLeft: 20, fontFamily: "'Noto Serif JP', serif" }} />
          {s.subtitle && <EditableText v={s.subtitle} on={ed?.subtitle} block style={{ fontSize: 14, color: "#555", lineHeight: 1.8, paddingLeft: 20, fontFamily: "'Noto Serif JP', serif" }} />}
        </div>
    ...
    <div style={{ background: "#f8f5f0", width: "100%", aspectRatio: "3/4", fontFamily: FONT_FAMILY, position: "relative", overflow: "hidden", display: "flex", flexDirection: "column" }}>
      <div style={{ display: "flex", height: "100%" }}>
        ...
        <div style={{ flex: 1, padding: "28px 24px", display: "flex", flexDirection: "column", boxSizing: "border-box" }}>
          ...
          <EditableText v={s.heading} on={ed?.heading} block style={{ fontSize: 20, fontWeight: 700, color: "#1a1a1a", lineHeight: 1.4, marginBottom: 16, fontFamily: "'Noto Serif JP', serif" }} />
          <div style={{ flex: 1, borderLeft: "2px solid #eee", paddingLeft: 16 }}>
            <EditableText v={s.text} on={ed?.text} block style={{ fontSize: 14, color: "#444", lineHeight: 2 }} />
          </div>
          {s.extra && (
            <div style={{ marginTop: 16, padding: "14px 18px", background: "#fff", border: "1px solid #ddd", borderLeft: "3px solid #333" }}>
              <EditableText v={s.extra} on={ed?.extra} block style={{ fontSize: 13, color: "#555", lineHeight: 1.8 }} />
            </div>
          )}
  ...
  return (
    <div style={{ background: "#f8f5f0", width: "100%", aspectRatio: "3/4", fontFamily: FONT_FAMILY, position: "relative", overflow: "hidden", display: "flex", flexDirection: "column", justifyContent: "center", padding: "40px 32px", boxSizing: "border-box" }}>
      ...
      <div style={{ textAlign: "center" }}>
        ...
        <EditableText v={s.cta} on={ed?.cta} block style={{ fontSize: 24, fontWeight: 800, color: "#1a1a1a", marginBottom: 12, lineHeight: 1.4, fontFamily: "'Noto Serif JP', serif" }} />
        <EditableText v={s.sub} on={ed?.sub} block style={{ fontSize: 13, color: "#666", marginBottom: 28, lineHeight: 1.8, fontFamily: "'Noto Serif JP', serif" }} />
        <div style={{ display: "flex", flexWrap: "wrap", gap: 10, justifyContent: "center", marginBottom: 24 }}>
          {s.tags.map((t, i) => <span key={i} style={{ padding: "6px 14px", background: "#fff", border: "1px solid #ddd", fontSize: 11, color: "#333" }}><EditableTag text={t} c="#333" on={ed?.tag?.(i)} /></span>)}
        </div>
