// AI设计提示词 - 包含独立组件版和App内置版
import {
  JSON_FORMAT_REQUIREMENTS,
} from './common.js';

// ============================================================
// AIDesignGenerator 组件使用的提示词
// ============================================================

// AI设计系统提示词（AIDesignGenerator组件使用）
export const AI_DESIGN_PROMPT = `你是专业的小红书视觉设计师和排版专家。
...
// 带参考图的AI设计提示词（AIDesignGenerator组件使用）
export const AI_DESIGN_WITH_REFERENCE_PROMPT = `你是专业的小红书视觉设计师和排版专家。
...
// ============================================================
// App.jsx 内置AI设计模式使用的提示词
// ============================================================

// 配色方案
const COLOR_SCHEMES = `【丰富多样的配色方案】
...
// AI设计提示词 - 单页整页模式（App.jsx使用）
export const AI_DESIGN_PROMPT_SINGLE = `你是顶级的小红书视觉设计师，擅长创作精美、高转化率的内容排版。
...
// AI设计提示词 - 分页模式（App.jsx使用）
export const AI_DESIGN_PROMPT_SPLIT = `你是顶级的小红书视觉设计师，擅长创作精美的分页卡片排版。
